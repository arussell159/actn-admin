...
export function SiteHeader({
  ...
  return (
    <>
      <header className="sticky top-[env(safe-area-inset-top,0px)] z-40 mt-[env(safe-area-inset-top,0px)] flex h-10 shrink-0 items-center gap-2 bg-transparent transition-[width,height] ease-linear md:relative md:top-0 md:z-auto md:mt-0 md:h-(--header-height) md:border-b md:bg-background group-has-data-[collapsible=icon]/sidebar-wrapper:md:h-(--header-height)">
        <div
