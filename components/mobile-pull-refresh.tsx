...
export function MobilePullRefresh() {
  ...
  return createPortal(
    <div
      className="pointer-events-none fixed inset-x-0 top-0 z-50 flex justify-center pt-[calc(var(--content-top-offset)+0.25rem)] transition-opacity duration-150 md:hidden"
      style={{
