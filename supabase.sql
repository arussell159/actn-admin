...
drop policy if exists "Allow authenticated knowledge base access" on public.knowledge_base_notes;
...
grant select, insert, update, delete on public.knowledge_base_notes to authenticated;
