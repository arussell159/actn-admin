...
export function DashboardView() {
  ...
  return (
    <PageFrame
      ...
      header={<SiteHeader title="Dashboard" />}
    >
                      ...
                      {isInitialZohoLoad ? (
                        ...
                        countryTicketLeaders.map((country) => (
                          <Button
                            ...
                            type="button"
                            variant="ghost"
                            className="h-auto justify-between gap-3 rounded-md px-3 py-1.5 text-left"
                            onClick={() =>
                  ...
                  <Table className="hidden md:table">
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="w-44 pr-6">Assigned To</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {isInitialZohoLoad ? (
                        ...
                        <>
                          {visibleTickets.map((ticket) => {
                            return (
                              <TableRow key={ticket.id || ticket.ticketNumber}>
                            ...
                            <TableRow>
                              <TableCell colSpan={5} className="text-center">
                                <Button
                                  ...
                                  className="px-4"
                                  onClick={() =>
                                    setVisibleTicketCount((count) => count + 50)
                                  }
                                >
                                  Load more tickets
                                </Button>
