...
export function MobileTabBar() {
  ...
  return createPortal(
    <nav
      className="pointer-events-none fixed inset-x-0 bottom-0 z-40 flex justify-center px-5 pb-0 after:pointer-events-none after:fixed after:inset-x-0 after:bottom-0 after:h-[env(safe-area-inset-bottom,0px)] after:bg-background md:hidden"
